...
{
    public partial class DelTipoEquipo : Form
    {
        public DelTipoEquipo()
        {
            InitializeComponent();
        }
        ...
        private void DelTipoEquipo_Load(object sender, EventArgs e)
        {
        ...
        {
            umanager.BorrarTipoEquipo(new Datos.Tipo_equipoSet{
        ...
        private void DelTipoEquipo_FormClosing(object sender, FormClosingEventArgs e)
        {
