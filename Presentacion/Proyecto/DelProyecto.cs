...
{
    public partial class DelProyecto : Form
    {
        public DelProyecto()
        {
            InitializeComponent();
        ...
        private void DelProyecto_Load(object sender, EventArgs e)
        {
        ...
        {
            umanager.BorrarProject(new Datos.ProyectoSet()
            {
        ...
        private void DelProyecto_FormClosing(object sender, FormClosingEventArgs e)
        {
